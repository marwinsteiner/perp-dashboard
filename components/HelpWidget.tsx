...
const COMMANDS: CommandInfo[] = [
  ...
  { cmd: 'OMS', description: 'Full Order Management System. Opens both Ticket and Blotter side-by-side.', category: 'Operations' },
  { cmd: 'TICKET', description: 'Open a standalone floating Order Ticket.', category: 'Operations' },
  { cmd: 'BLOTTER', description: 'Open a standalone floating Working Order Blotter.', category: 'Operations' },
